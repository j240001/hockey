    ...
    const TREE_RW = 
        new SelectorNode([            new ActionNode(bb => intel_test(bb), "Intel Scan"),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.hasPuck),
                ...
                new ActionNode(bb => ({ tx: bb.p.x + (bb.forwardDir * 80), ty: bb.p.y, action: "none" }), "Lane Carry")]),
            new SequenceNode([                new ConditionNode(bb => bb.hasPuck),
                new ConditionNode(bb => bb.puckInNeuZone),
                new ActionNode(bb => ({ tx: bb.p.x + (bb.forwardDir * 80), ty: bb.p.y, action: "none" }), "Lane Carry")]),
            new SequenceNode([                new ConditionNode(bb => bb.loosePuck),
                new ConditionNode(bb => {let myD=Math.hypot(bb.p.x-puck.x,bb.p.y-puck.y); if(80>0 && myD<80) return true; let c=null,d=9999; for(let m of players){if(m.team===bb.p.team && m.type==='skater'){let dist=Math.hypot(m.x-puck.x,m.y-puck.y);if(dist<d){d=dist;c=m;}}}return c&&c.id===bb.p.id;}),
                new ActionNode(bb => { try { const t = (typeof getPuckIntercept === 'function') ? getPuckIntercept(bb.p, 1.5) : { x: puck.x, y: puck.y }; return { tx: t.x, ty: t.y, action: "none" }; } catch(e) { return { tx: bb.p.x, ty: bb.p.y, action: "none" }; } }, "Intercept")]),
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                new ConditionNode(bb => {let myD=Math.hypot(bb.p.x-puck.x,bb.p.y-puck.y); if(80>0 && myD<80) return true; let c=null,d=9999; for(let m of players){if(m.team===bb.p.team && m.type==='skater'){let dist=Math.hypot(m.x-puck.x,m.y-puck.y);if(dist<d){d=dist;c=m;}}}return c&&c.id===bb.p.id;}),
                new ActionNode(bb => { try { const t = (typeof getPuckIntercept === 'function') ? getPuckIntercept(bb.p, 1.5) : { x: puck.x, y: puck.y }; return { tx: t.x, ty: t.y, action: "none" }; } catch(e) { return { tx: bb.p.x, ty: bb.p.y, action: "none" }; } }, "Intercept")]),
            new SequenceNode([                new ConditionNode(bb => bb.puckInDefZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"150","minDistOppGoal":"400","minDistLeftBoard":"200","minDistRightBoard":"50"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.puckInNeuZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"300","minDistOppGoal":"250","minDistLeftBoard":"200","minDistRightBoard":"50"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.puckInOffZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"500","minDistOppGoal":"0","minDistLeftBoard":"200","minDistRightBoard":"50"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")])]);
    const TREE_LD = 
