    ...
    const TREE_LW = 
        new SelectorNode([            new ActionNode(bb => intel_test(bb), "Intel Scan"),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.hasPuck),
                ...
                new ActionNode(bb => pass_test(bb, 40), "Pass Test")]),
            new SequenceNode([                new ConditionNode(bb => bb.loosePuck),
                new ConditionNode(bb => {let myD=Math.hypot(bb.p.x-puck.x,bb.p.y-puck.y); if(200>0 && myD<200) return true; let c=null,d=9999; for(let m of players){if(m.team===bb.p.team && m.type==='skater'){let dist=Math.hypot(m.x-puck.x,m.y-puck.y);if(dist<d){d=dist;c=m;}}}return c&&c.id===bb.p.id;}),
                new ActionNode(bb => { try { const t = (typeof getPuckIntercept === 'function') ? getPuckIntercept(bb.p, 1.5) : { x: puck.x, y: puck.y }; return { tx: t.x, ty: t.y, action: "none" }; } catch(e) { return { tx: bb.p.x, ty: bb.p.y, action: "none" }; } }, "Intercept")]),
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                new ConditionNode(bb => { try { return (typeof amILastMan === 'function' ? amILastMan(bb.p) : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getAggressiveGapTarget === 'function' ? getAggressiveGapTarget(bb.p, (typeof getPuckCarrier === 'function' ? getPuckCarrier() : puck), bb.myGoalX) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} })]),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.loosePuck),
                new ConditionNode(bb => bb.puckInOffZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"525","minDistOppGoal":"50","minDistLeftBoard":"100","minDistRightBoard":"180"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.teamHasPuck),
                new ConditionNode(bb => bb.puckInOffZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"525","minDistOppGoal":"50","minDistLeftBoard":"100","minDistRightBoard":"180"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.puckInNeuZone),
                new ConditionNode(bb => bb.teamHasPuck),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"350","minDistOppGoal":"250","minDistLeftBoard":"50","minDistRightBoard":"200"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.puckInDefZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"100","minDistOppGoal":"500","minDistLeftBoard":"50","minDistRightBoard":"200"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")])]);
    const TREE_RW = 
        new SelectorNode([            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                new ConditionNode(bb => { try { return (typeof amILastMan === 'function' ? amILastMan(bb.p) : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getAggressiveGapTarget === 'function' ? getAggressiveGapTarget(bb.p, (typeof getPuckCarrier === 'function' ? getPuckCarrier() : puck), bb.myGoalX) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} })]),
