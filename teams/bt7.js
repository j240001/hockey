// Ottawa (OTT) - Generated by Builder V34
(function() {
...
// --- UPDATED VISION CHECK (Supports Smart Shot Parameters) ---
    ...
    function predictLeadPass(passer, receiver) {
        ...
        function pass_test(bb, minOpenness = 40) {
            ...
            // PARALLAX FIX
            const startX = (bb.p.bladePos && !isNaN(bb.p.bladePos.x)) ? bb.p.bladePos.x : bb.p.x;
            const startY = (bb.p.bladePos && !isNaN(bb.p.bladePos.y)) ? bb.p.bladePos.y : bb.p.y;
            ...
            for (let m of players) {
                if (m.team === bb.p.team && m.id !== bb.p.id && m.role !== "Goalie") {
                    ...
                    if (safety >= minOpenness) {
                        // Check from Blade
                        if (typeof isLaneBlocked === 'function' && isLaneBlocked(startX, startY, m.x, m.y, bb.p.team)) {
                            continue;
                        }
    ...
    const TREE_LD = 
        new SelectorNode([            new SequenceNode([                new ConditionNode(bb => bb.puckInDefZone),
            ...
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===3 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"150","minDistOppGoal":"450","minDistLeftBoard":"100","minDistRightBoard":"170"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")])]);
    const TREE_RD = 
        new SelectorNode([            new SequenceNode([                new ConditionNode(bb => bb.loosePuck),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                new ConditionNode(bb => bb.puckInOffZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"50","minDistOppGoal":"500","minDistLeftBoard":"100","minDistRightBoard":"100"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.hasPuck),
                ...
                new ActionNode(bb => getSmartShootTarget(bb.p, bb, 15, 10), "smartshoot")]),
            new ActionNode(bb => carrier_intel(bb, 0), "Carrier Intel"),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.loosePuck),
                new ConditionNode(bb => bb.puckInNeuZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"0","minDistOppGoal":"500","minDistLeftBoard":"150","minDistRightBoard":"100"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.loosePuck),
                new ConditionNode(bb => bb.puckInDefZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"20","minDistOppGoal":"600","minDistLeftBoard":"160","minDistRightBoard":"100"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.puckInOffZone),
                new ConditionNode(bb => bb.oppHasPuck),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.teamHasPuck),
                new ConditionNode(bb => bb.puckInDefZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"50","minDistOppGoal":"550","minDistLeftBoard":"150","minDistRightBoard":"100"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.teamHasPuck),
                new ConditionNode(bb => bb.puckInNeuZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"50","minDistOppGoal":"550","minDistLeftBoard":"150","minDistRightBoard":"100"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.teamHasPuck),
                new ConditionNode(bb => bb.puckInOffZone),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"440","minDistOppGoal":"160","minDistLeftBoard":"200","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")])]);
