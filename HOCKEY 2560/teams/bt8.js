    ...
    const TREE_C = 
        new SelectorNode([            new SequenceNode([                new ConditionNode(bb => { try { return (typeof amILastMan === 'function' ? amILastMan(bb.p) : false); } catch(e){return false;} }),
            ...
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===1 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"60","minDistOppGoal":"400","minDistLeftBoard":"150","minDistRightBoard":"150"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===2 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"180","minDistOppGoal":"300","minDistLeftBoard":"150","minDistRightBoard":"150"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===3 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"200","minDistOppGoal":"325","minDistLeftBoard":"200","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===4 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"300","minDistOppGoal":"325","minDistLeftBoard":"200","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===5 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"550","minDistOppGoal":"0","minDistLeftBoard":"200","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
    ...
    const TREE_LW = 
        new SelectorNode([            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.hasPuck),
                ...
                new ActionNode(bb => { try { const t = (typeof findLeastGuardedInZone === 'function' ? findLeastGuardedInZone(bb.p, bb) : null); if(t){ return {tx:t.x, ty:t.y, action:"pass", target:t}; } return "FAILURE"; } catch(e){return "FAILURE";} }, "OZONE R PASS")]),
            new SequenceNode([                new ConditionNode(bb => bb.hasPuck),
                new ConditionNode(bb => { try { const t = (typeof findQualifiedBreakout === 'function' ? findQualifiedBreakout(bb.p, bb, {safety:60,fwd:150,back:10}) : null); if(t){bb.passTarget=t; return true;} return false; } catch(e){return false;} }),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.hasPuck),
                new ActionNode(bb => { if(bb.carryTarget)return{tx:bb.carryTarget.x,ty:bb.carryTarget.y,action:"none"}; return {tx:bb.enemyGoal,ty:(typeof RY !== 'undefined' ? RY : 300),action:"none"}; }, "Carry")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===1 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"30","minDistOppGoal":"500","minDistLeftBoard":"220","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===2 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"40","minDistOppGoal":"500","minDistLeftBoard":"220","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===3 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"100","minDistOppGoal":"325","minDistLeftBoard":"220","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===4 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"200","minDistOppGoal":"325","minDistLeftBoard":"220","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===5 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"550","minDistOppGoal":"0","minDistLeftBoard":"220","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===6 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"550","minDistOppGoal":"0","minDistLeftBoard":"220","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")])]);
    const TREE_RW = 
        new SelectorNode([            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.hasPuck),
                new ActionNode(bb => { if(bb.carryTarget)return{tx:bb.carryTarget.x,ty:bb.carryTarget.y,action:"none"}; return {tx:bb.enemyGoal,ty:(typeof RY !== 'undefined' ? RY : 300),action:"none"}; }, "Carry")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===1 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"30","minDistOppGoal":"500","minDistLeftBoard":"0","minDistRightBoard":"220"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===2 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"40","minDistOppGoal":"500","minDistLeftBoard":"0","minDistRightBoard":"220"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===3 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"100","minDistOppGoal":"325","minDistLeftBoard":"0","minDistRightBoard":"220"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===4 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"200","minDistOppGoal":"325","minDistLeftBoard":"0","minDistRightBoard":"220"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===5 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"550","minDistOppGoal":"0","minDistLeftBoard":"0","minDistRightBoard":"220"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===6 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"550","minDistOppGoal":"0","minDistLeftBoard":"0","minDistRightBoard":"220"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")])]);
    const TREE_LD = 
        new SelectorNode([            new SequenceNode([                new ConditionNode(bb => bb.puckInDefZone),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.hasPuck),
                new ActionNode(bb => { if(bb.carryTarget)return{tx:bb.carryTarget.x,ty:bb.carryTarget.y,action:"none"}; return {tx:bb.enemyGoal,ty:(typeof RY !== 'undefined' ? RY : 300),action:"none"}; }, "Carry")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===1 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"30","minDistOppGoal":"600","minDistLeftBoard":"160","minDistRightBoard":"160"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===2 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"40","minDistOppGoal":"500","minDistLeftBoard":"220","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                ...
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"30","minDistOppGoal":"550","minDistLeftBoard":"140","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                ...
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"30","minDistOppGoal":"550","minDistLeftBoard":"160","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                ...
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"0","minDistOppGoal":"425","minDistLeftBoard":"150","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                ...
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"0","minDistOppGoal":"325","minDistLeftBoard":"150","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===5 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"180","minDistOppGoal":"180","minDistLeftBoard":"100","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===6 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"440","minDistOppGoal":"180","minDistLeftBoard":"100","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===4 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"0","minDistOppGoal":"450","minDistLeftBoard":"160","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===3 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"60","minDistOppGoal":"500","minDistLeftBoard":"140","minDistRightBoard":"0"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")])]);
    const TREE_RD = 
        new SelectorNode([            new SequenceNode([                new ConditionNode(bb => bb.puckInDefZone),
                new ConditionNode(bb => bb.oppHasPuck),
                new ActionNode(bb => { try { return (typeof getAggressiveGapTarget === 'function' ? getAggressiveGapTarget(bb.p, (typeof getPuckCarrier === 'function' ? getPuckCarrier() : puck), bb.myGoalX) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} })]),
            ...
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===3 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"30","minDistOppGoal":"550","minDistLeftBoard":"0","minDistRightBoard":"140"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===4 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"30","minDistOppGoal":"550","minDistLeftBoard":"0","minDistRightBoard":"160"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===5 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"0","minDistOppGoal":"425","minDistLeftBoard":"0","minDistRightBoard":"150"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => bb.oppHasPuck),
                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===6 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"0","minDistOppGoal":"325","minDistLeftBoard":"0","minDistRightBoard":"150"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===5 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"180","minDistOppGoal":"180","minDistLeftBoard":"0","minDistRightBoard":"100"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===6 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"440","minDistOppGoal":"180","minDistLeftBoard":"0","minDistRightBoard":"100"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===4 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"0","minDistOppGoal":"450","minDistLeftBoard":"0","minDistRightBoard":"160"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")]),
            new SequenceNode([                new ConditionNode(bb => { try { return (typeof getFormationZone==='function' ? getFormationZone(puck.x, bb.p.team)===3 : false); } catch(e){return false;} }),
                new ActionNode(bb => { try { return (typeof getPositionWithinLimits === 'function' ? getPositionWithinLimits(bb.p, bb, {"type":"actGoToPosition","cat":"act","minDistOwnGoal":"60","minDistOppGoal":"500","minDistLeftBoard":"0","minDistRightBoard":"140"}) : {tx:bb.p.x,ty:bb.p.y,action:'none'}); } catch(e){return {tx:bb.p.x,ty:bb.p.y,action:'none'};} }, "Go To Pos")])]);
