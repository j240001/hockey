// CHAMPION_52PTS_Ep6155_EVOLVED (PRO) - Generated by Builder V30 (Safe Mode)
(function() {
    const STRATEGY_ID = "BT_" + "PRO_" + Math.floor(Math.random() * 99999);
    ...
    if (typeof registerStrategy === "function") {
        registerStrategy(
            STRATEGY_ID,
            "CHAMPION_52PTS_Ep6155_EVOLVED",
            "Wild",
            "MIN",
            think,
            { main: "#4dab60", secondary: "#ffffff" }
        );
    }
})();