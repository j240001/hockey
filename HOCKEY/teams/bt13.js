// ==========================================
// STRATEGY: MyStrategy (MTX)
// Generated by Builder V23 (SafeFix)
// ==========================================
(function() {
    const STRATEGY_ID = "BT_" + "MTX_" + Math.floor(Math.random()*99999);
    ...
    const TREE_C = 
        new SelectorNode([
            ...
            new SequenceNode([
                condTeamHasPuck,
                new ConditionNode(bb => (typeof getFormationZone==='function'?getFormationZone(puck.x, bb.p.team) === 1 : false)),
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * -200), ty: RY + 0, action: 'none' }))
            ]),
            new SequenceNode([
                condTeamHasPuck,
                new ConditionNode(bb => (typeof getFormationZone==='function'?getFormationZone(puck.x, bb.p.team) === 2 : false)),
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * -100), ty: RY + 0, action: 'none' }))
            ]),
            new SequenceNode([
                condTeamHasPuck,
                new ConditionNode(bb => (typeof getFormationZone==='function'?getFormationZone(puck.x, bb.p.team) === 3 : false)),
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * 0), ty: RY + 0, action: 'none' }))
            ]),
            new SequenceNode([
                condTeamHasPuck,
                new ConditionNode(bb => (typeof getFormationZone==='function'?getFormationZone(puck.x, bb.p.team) === 4 : false)),
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * 100), ty: RY + 0, action: 'none' }))
            ]),
            new SequenceNode([
                condTeamHasPuck,
                new ConditionNode(bb => (typeof getFormationZone==='function'?getFormationZone(puck.x, bb.p.team) === 5 : false)),
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * 200), ty: RY + 0, action: 'none' }))
            ]),
            new SequenceNode([
                condTeamHasPuck,
                new ConditionNode(bb => (typeof getFormationZone==='function'?getFormationZone(puck.x, bb.p.team) === 6 : false)),
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * 200), ty: RY + 0, action: 'none' }))
            ]),
            new SequenceNode([
                condOppHasPuck,
            ...
            new SequenceNode([
                condOppHasPuck,
                condPuckInOffZone,
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * 100), ty: RY + -100, action: 'none' }))
            ]),
            new SequenceNode([
                condOppHasPuck,
                condPuckInNeuZone,
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * -50), ty: RY + 0, action: 'none' }))
            ]),
            new SequenceNode([
                condOppHasPuck,
                condPuckInDefZone,
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * -150), ty: RY + 0, action: 'none' }))
            ]),
            new SequenceNode([
                condLoosePuck,
                condAmIClosest,
    ...
    const TREE_RW = 
        new SelectorNode([
            ...
            new SequenceNode([
                condLoosePuck,
                condPuckInDefZone,
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * -150), ty: RY + 100, action: 'none' }))
            ]),
            new SequenceNode([
                condLoosePuck,
                condPuckInNeuZone,
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * 0), ty: RY + 100, action: 'none' }))
            ]),
            new SequenceNode([
                condLoosePuck,
                condPuckInOffZone,
    ...
    const TREE_LD = 
        new SelectorNode([
            ...
            new SequenceNode([
                condTeamHasPuck,
                new ConditionNode(bb => (typeof getFormationZone==='function'?getFormationZone(puck.x, bb.p.team) === 1 : false)),
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * -250), ty: RY + 0, action: 'none' }))
            ]),
            new SequenceNode([
                condTeamHasPuck,
                new ConditionNode(bb => (typeof getFormationZone==='function'?getFormationZone(puck.x, bb.p.team) === 2 : false)),
            ...
            new SequenceNode([
                condTeamHasPuck,
                new ConditionNode(bb => (typeof getFormationZone==='function'?getFormationZone(puck.x, bb.p.team) === 6 : false)),
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * 120), ty: RY + -100, action: 'none' }))
            ]),
            new SequenceNode([
                condOppHasPuck,
                condAmIClosest,
            ...
            new SequenceNode([
                condOppHasPuck,
                condPuckInDefZone,
                new ActionNode(bb => ({ tx: bb.safeRX + (bb.forwardDir * -300), ty: RY + 0, action: 'none' }))
            ]),
            new SequenceNode([
                condLoosePuck,
                condAmIClosest,
    ...
    if (typeof registerStrategy === "function") {
        registerStrategy(STRATEGY_ID, "MyStrategy", "Matrix", "MTX", think, { main: "#6600ff", secondary: "#020203" });
    }
})();
